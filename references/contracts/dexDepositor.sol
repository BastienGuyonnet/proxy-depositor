...
contract dexDepositor{

    address public constant dexToken = address(); //address of token to lock up
    address public constant escrow = address(); //address of token after it is locked up
    uint256 private constant MAXTIME = 4 * 364 * 86400; //max lock up time
    uint256 private constant WEEK = 7 * 86400;

    uint256 public constant FEE_DENOMINATOR = 10000;

    address public immutable staker; //VoterProxy in Convex or proxyDepositor in ours, the base level contract
    address public immutable minter; //proxyToken
