...
contract CrvDepositor{
    ...
    /** Supposedly called the first time
    *   vecrv should = 0, if not, pointless
    *   release lock if exist ? (cannot find staker code)
    *   get crv balance, and create lock, store unlock time
    */
